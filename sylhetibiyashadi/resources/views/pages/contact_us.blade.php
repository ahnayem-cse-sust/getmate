            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="cname" value="{{ old('cname') }}" class="form-control @error('cname') is-invalid @enderror" id="name-input" aria-required="true" aria-invalid="false" required>
                        @error('cname')
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="cemail" value="{{ old('cemail') }}" class="form-control @error('cemail') is-invalid @enderror" id="email-input" aria-required="true" aria-invalid="false" required>
                        @error('cemail')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" name="cphone" value="{{ old('cphone') }}" size="40" class="form-control @error('cphone') is-invalid @enderror" id="phone-input" aria-invalid="false" required>
                        @error('cphone')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
